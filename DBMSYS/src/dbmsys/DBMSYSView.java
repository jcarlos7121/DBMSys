 ...
 */
public class DBMSYSView extends FrameView {
    
    public DBMSYSView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        dbmsys.Cliente c = new dbmsys.Cliente();
    ...
    public void deleteRecord() {
        ...
        List<dbmsys.Cliente> toRemove = new ArrayList<dbmsys.Cliente>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            dbmsys.Cliente c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<dbmsys.Cliente> merged = new ArrayList<dbmsys.Cliente>(list.size());
                for (dbmsys.Cliente c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DBMSYSApp.getApplication().getMainFrame();
            aboutBox = new DBMSYSAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DBMSYSApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        noClienteLabel = new javax.swing.JLabel();
        ...
        descuentoClienteLabel = new javax.swing.JLabel();
        noClienteField = new javax.swing.JTextField();
        ...
        descuentoClienteField = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dbmsys.DBMSYSApp.class).getContext().getResourceMap(DBMSYSView.class);
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${noCliente}"));
        columnBinding.setColumnName("No Cliente");
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${descuentoCliente}"));
        columnBinding.setColumnName("Descuento Cliente");
        columnBinding.setColumnClass(Float.class);
        bindingGroup.addBinding(jTableBinding);

        masterScrollPane.setViewportView(masterTable);

        noClienteLabel.setText(resourceMap.getString("noClienteLabel.text")); // NOI18N
        noClienteLabel.setName("noClienteLabel"); // NOI18N

        nombreLabel.setText(resourceMap.getString("nombreLabel.text")); // NOI18N
        nombreLabel.setName("nombreLabel"); // NOI18N

        apellidoMLabel.setText(resourceMap.getString("apellidoMLabel.text")); // NOI18N
        apellidoMLabel.setName("apellidoMLabel"); // NOI18N

        apellidoPLabel.setText(resourceMap.getString("apellidoPLabel.text")); // NOI18N
        apellidoPLabel.setName("apellidoPLabel"); // NOI18N

        calleLabel.setText(resourceMap.getString("calleLabel.text")); // NOI18N
        calleLabel.setName("calleLabel"); // NOI18N
        ...
        cpLabel.setText(resourceMap.getString("cpLabel.text")); // NOI18N
        cpLabel.setName("cpLabel"); // NOI18N

        paisLabel.setText(resourceMap.getString("paisLabel.text")); // NOI18N
        paisLabel.setName("paisLabel"); // NOI18N
        ...
        descuentoClienteLabel.setText(resourceMap.getString("descuentoClienteLabel.text")); // NOI18N
        descuentoClienteLabel.setName("descuentoClienteLabel"); // NOI18N

        noClienteField.setName("noClienteField"); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.noCliente}"), noClienteField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), noClienteField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        apellidoMField.setName("apellidoMField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.apellidoM}"), apellidoMField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), apellidoMField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        apellidoPField.setName("apellidoPField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.apellidoP}"), apellidoPField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), apellidoPField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        calleField.setName("calleField"); // NOI18N
        ...
        paisField.setName("paisField"); // NOI18N
        ...
        rfcField.setName("rfcField"); // NOI18N
        ...
        descuentoClienteField.setName("descuentoClienteField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.descuentoCliente}"), descuentoClienteField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), descuentoClienteField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dbmsys.DBMSYSApp.class).getContext().getActionMap(DBMSYSView.class, this);
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(noClienteLabel)
                            .addComponent(nombreLabel)
                            .addComponent(apellidoMLabel)
                            ...
                            .addComponent(descuentoClienteLabel))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(noClienteField, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(apellidoPField)
                            .addComponent(apellidoMField)
                            .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(calleField)
                            .addComponent(descuentoClienteField))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 267, Short.MAX_VALUE))
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(masterScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 593, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(noClienteLabel)
                    .addComponent(noClienteField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nombreLabel)
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(descuentoClienteLabel)
                    .addComponent(descuentoClienteField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(refreshButton)
    ...
    private javax.swing.JTextField descuentoClienteField;
    private javax.swing.JLabel descuentoClienteLabel;
    ...
    private java.util.List<dbmsys.Cliente> list;
    private javax.swing.JPanel mainPanel;
    private javax.swing.JScrollPane masterScrollPane;
    private javax.swing.JTable masterTable;
    private javax.swing.JMenuBar menuBar;
    private javax.swing.JButton newButton;
    private javax.swing.JTextField noClienteField;
    private javax.swing.JLabel noClienteLabel;
